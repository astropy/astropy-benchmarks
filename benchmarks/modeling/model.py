...
gauss1d_with_units = models.Gaussian1D(
    amplitude=10 * u.Hz, mean=5 * u.m, stddev=1.2 * u.cm
)
...
def time_model_init_2():
    models.Polynomial1D(1, c0=0.2, c1=3.4)


def time_init_gaussian_no_units():
    models.Gaussian1D(amplitude=10, mean=5, stddev=1.2)


def time_init_gaussian_with_units():
    models.Gaussian1D(amplitude=10 * u.Hz, mean=5 * u.m, stddev=1.2 * u.cm)
